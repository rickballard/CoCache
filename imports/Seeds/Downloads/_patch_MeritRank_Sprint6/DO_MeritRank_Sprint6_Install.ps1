...
CopyUtf8 "$base\config\registry.schema.json"    (Join-Path $RepoRoot 'config\registry.schema.json')

CopyUtf8 "$base\scripts\validate_config.ps1"    (Join-Path $RepoRoot 'scripts\validate_config.ps1')
CopyUtf8 "$base\scripts\validate_registry.ps1"  (Join-Path $RepoRoot 'scripts\validate_registry.ps1')
...
CopyUtf8 "$base\scripts\weights_provenance.ps1" (Join-Path $RepoRoot 'scripts\weights_provenance.ps1')
...
Write-Host "✔ Sprint-6 files installed/updated" -ForegroundColor Green