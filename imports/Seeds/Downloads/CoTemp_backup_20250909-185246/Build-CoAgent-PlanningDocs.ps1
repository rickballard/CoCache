...
$checklist="# CoAgent - Planning Readiness Checklist`n`nStatus: DRAFT.`n`n## Gates`n- [ ] G1 - RFC-0001 v0.1 public comment window: $start -> $end.`n- [ ] G2 - MVP tests pass twice.`n- [ ] G3 - Risk register clean of Sev-1.`n- [ ] G4 - Consent-Lock unchanged.`n- [ ] G5 - Scope freeze P0 items.`n- [ ] G6 - Sandbox drills evidence.`n- [ ] G7 - Docs in place.`n- [ ] G8 - CoTemp-by-default wiring active.`n"
